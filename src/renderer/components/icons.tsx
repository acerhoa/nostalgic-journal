/* ============================================================
   ICONS — ported from the original inline SVG markup
   ============================================================ */
...
export function CalcIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <line x1="15.5" y1="15" x2="15.5" y2="15" />
      <line x1="8.5" y1="18.3" x2="8.5" y2="18.3" />
      <line x1="12" y1="18.3" x2="12" y2="18.3" />
      <line x1="15.5" y1="18.3" x2="15.5" y2="18.3" />
    </svg>
  );
}
